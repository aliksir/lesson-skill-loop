#!/bin/bash
# ===========================================
# lesson-skill-loop — アップデート確認スクリプト
# ===========================================
#
# 使い方:
...
#   bash path/to/lesson-skill-loop/scripts/check-update.sh &
#
...
# --- 設定 ---
CACHE_FILE="${HOME}/.claude/.lesson-skill-loop-update-cache"
CACHE_TTL=86400  # 24時間（秒）
GITHUB_API="https://api.github.com/repos/aliksir/lesson-skill-loop/releases/latest"
...
🔔 lesson-skill-loop: 新バージョン v${remote_ver} が利用可能です（現在: v${local_ver}）
